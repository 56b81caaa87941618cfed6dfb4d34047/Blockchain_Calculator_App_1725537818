<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get in Touch with Blockchain Calc</h3>
        <p class="mt-3 text-black w-fit">Have questions about our blockchain calculator? We're here to help!</p>
      </div>
